...
public class VisualizationMapAppSQL extends Frame{
...
//	private String ptpEdgesFile = "output/EdgesOutput/IFM_2.0_RailEdges_2015.csv";
//	private String ptpEdgesFile = "output/EdgesOutput/IFM_2.0_RailEdges_2030.csv";
//	private String ptpEdgesFile = "output/EdgesOutput/IFM_2.0_RailEdges_2050.csv";
	
//	private String ptpEdgesFile = "output/EdgesOutput/IFM_2.0_MaritimeEdges_2015.csv";
	private String ptpEdgesFile = "output/MaritimeEdges_CO2_2015.csv";
	
//	private String ptpEdgesFile = "output/EdgesOutput/IFM_2.0_RoadEdges_2050.csv";
...
//		this.setSize(1400,750);
	...
	{	
		VisualizationMapAppSQL mapApp = new VisualizationMapAppSQL(); 
  ...
  This method adds an applet to the bezier frame for drawing the bezier curve
	...
	private void addApplet(String ptpEdgesfile, String portThroughputFile, boolean SQLdatabase)
	{
		...
		this.applet = new GlobalMaritimeShipping(ptpEdgesfile, portThroughputFile, SQLdatabase);
	...
	private class WindowHandler extends WindowAdapter implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			else if(e.getActionCommand().equalsIgnoreCase("Open"))
			{
				...
				int result = jfc.showOpenDialog(VisualizationMapAppSQL.this);
...
//						applet.repaint();
						...
						JOptionPane.showMessageDialog(VisualizationMapAppSQL.this,a.getMessage(),"File error",JOptionPane.ERROR_MESSAGE);
					}
				}
			}
			...
			else if (e.getActionCommand().equalsIgnoreCase("Save"))
			{
				...
				JFileChooser jfc = new JFileChooser();
				int result = jfc.showSaveDialog(VisualizationMapAppSQL.this);
				if(result == JFileChooser.APPROVE_OPTION) 
					try {
